 ...
 */
class UpSpaAssetLinkVerifier(
    private val fetcher: AssetLinkFetcher = FakeAssetLinkFetcher.empty(),
    ...
    /**
     * Pure in-memory verification bypassing the fetcher layer completely.
     */
    fun verifyEvidence(
        origin: Origin,
        appSigningInfo: AppSigningInfo,
    ...
    ): VerificationResult = pureVerifier.verifyStatements(origin, appSigningInfo, statements, requiredRelation)
